...
export default function ConfirmAccountView() {
  ...
  useEffect(() => {
    if (!email) {
      toast.error('Sesión inválida, por favor regístrate de nuevo');
  ...
  const handleChange = (index: number, value: string) => {
    ...
    // Manejar el pegado de múltiples dígitos
    if (val.length > 1) {
    ...
    <AuthLayout>
      <div className="w-full max-w-md bg-[#0F1523]/80 backdrop-blur-xl p-8 rounded-3xl border border-slate-800/50 shadow-2xl relative">
        ...
        <div className="mt-8 mb-10 text-center">
          <h1 className="text-3xl font-extrabold text-white tracking-tight mb-2">Confirmar Cuenta</h1>
