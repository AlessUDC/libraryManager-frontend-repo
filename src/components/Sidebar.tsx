...
import { UserGroupIcon, TagIcon, MagnifyingGlassIcon, TicketIcon, BanknotesIcon, ShieldCheckIcon } from '@heroicons/react/24/outline';
...
export default function Sidebar({
  ...
  const menuItems = allMenuItems.filter(item => {
    ...
    if (isAdmin) {
      return ['Catálogo', 'Autores', 'Categorías', 'Usuarios', 'Gestión Préstamos y Reservas', 'Auditoría de Sistema'].includes(item.name);
    }
